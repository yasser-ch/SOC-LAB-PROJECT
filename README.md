...
| Mounir Merghich | Network Engineer | pfSense + Suricata | `10.0.8.1` | [@](https://github.com/username) |
| Malak Belkhou | SOAR Engineer | Shuffle + DVWA + Windows Client | `10.0.8.4` | [@](https://github.com/username) |
| Landry Dossah | Red Team / Deception | Kali Linux + Cowrie Honeypot | `10.0.8.6` / `10.0.8.10` | [@m4jesty228](https://github.com/m4jesty228) |
